		 ...
		 <div class="col-sm-12">
		       <?php 
			    if(isset($_GET['u_id']))
				{
					 ...
					 $select= "select * from users where user _id='$user_id' ";
					  ...
					  echo "
					      <div class='row'>
							  ...
							  <ul class='list-group'>
								   ...
								   <li class='list-group-item' title='Education'><strong>$education</strong></li>
								  ...
								  if($content=="No" && strlen($upload_image) >= 1){
									   echo"
									       <div id='own_post'>
										       <div class='row'>
											        <div class='col-sm-2'>
													  <p><img src='user/$user_image' class='img-circle' width='100' height='100'></p>
													</div>
													<div class='col-sm-6'>
