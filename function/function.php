...
function get_posts()
{
   ...
   function single_post(){
		...
		$row_user = mysqli_fetch_array($run_posts);
		 ...
		 }else
		 {
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					<div class='row'>
						<div class='col-sm-2'>
						<p><img class='img-circle' src='user/$user_image'  width='100px' height='100px'></p>
						</div>
						<div class='col-sm-6'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							<h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='single.php?posts_id=$posts_id' style='float:right;'><button class='btn btn-info'>Comment</button></a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
			 ...
			 <div class='col-sm-6'>
			    <div class='row' id='find_people'>
				   <div class='col-sm-4'>
					   ...
					   <img src='user/$user_image' width='150px' height='140px' title='$user_name' style='float:left; ,margin:1px;' />
					   </a>
			       </div><br><br>
				   <div class='col-sm--6'>
