						...
						while($row_user = mysqli_fetch_array($run_user)){
								  ...
								  echo "
								      <div class='container-fluid'>
									     <a style='text-decoration: none; cursor: pointer; color: #3987F0' href='messages.php?u_id=$user_id'>
										 <img src='user/$user_image' class='img-circle' width='90px' height='80px' title='$user_name'><strong>&nbsp $first_name  $last_name</strong><br><br>
										 </a>
									  </div>
								  ";
						}
						 ...
						 <?php
						        if(isset($_POST['send_msg'])){
									...
									if($msg == ""){
										...
										echo"<h4 style='color:red; text-align: center;'>Message is to long ! use only 37 character<h4>";
									}else{
							    ...
							    <div class='row'>
									...
									<div style='background-color: #e6e6e6;' class='col-sm-9'>
									       <h2>Information About</h2>
										       <img src='user/$user_image' class='img-circle' width='150' height='150'>
											   <br><br>
											   <ul class='list-group'>
												 ...
												 <li class='list-group-item' title='Education'>$education</li>
